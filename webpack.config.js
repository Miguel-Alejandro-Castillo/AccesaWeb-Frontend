...
function buildExtensionIcon() {
  return new CopyWebpackPlugin([{
    from: './src/assets/images/icon16x16.png',
    to: 'icons/icon16x16.png'
  }, {
    from: './src/assets/images/icon20x20.png',
    to: 'icons/icon20x20.png'
  }, {
    from: './src/assets/images/icon24x24.png',
    to: 'icons/icon24x24.png'
  }, {
    from: './src/assets/images/icon32x32.png',
    to: 'icons/icon32x32.png'
  }, {
    from: './src/assets/images/icon64x64.png',
    to: 'icons/icon64x64.png'
  }, {
    from: './src/assets/images/icon128x128.png',
    to: 'icons/icon128x128.png'
  }, {
    from: './src/assets/images/icon256x256.png',
    to: 'icons/icon256x256.png'
  }, {
    from: './src/assets/images/icon512x512.png',
